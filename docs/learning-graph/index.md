...
The course description scored **100/100**.
...
- Longest dependency chain: 11 concepts
...
- 11 concept classifier categories
- Category organization — foundational mechanics and verb/grammar systems first, vocabulary by unit, culture and communication frameworks, assessment and capstone projects last
- Balanced categories (3.0% – 13.0% each)
- All categories well under the 30% threshold
